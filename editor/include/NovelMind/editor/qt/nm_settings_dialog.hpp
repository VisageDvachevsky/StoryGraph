...
public:
  explicit NMSettingWidget(const SettingDefinition &def,
...
public:
  explicit NMBoolSettingWidget(const SettingDefinition &def,
                               QWidget *parent = nullptr);
...
public:
  explicit NMIntSettingWidget(const SettingDefinition &def,
                              QWidget *parent = nullptr);
...
public:
  explicit NMFloatSettingWidget(const SettingDefinition &def,
                                QWidget *parent = nullptr);
...
public:
  explicit NMStringSettingWidget(const SettingDefinition &def,
                                 QWidget *parent = nullptr);
...
public:
  explicit NMEnumSettingWidget(const SettingDefinition &def,
                               QWidget *parent = nullptr);
...
public:
  explicit NMPathSettingWidget(const SettingDefinition &def,
                               QWidget *parent = nullptr);
...
public:
  explicit NMSettingsCategoryPage(const std::string &category,
...
public:
  explicit NMSettingsDialog(NMSettingsRegistry *registry,
                            QWidget *parent = nullptr);
