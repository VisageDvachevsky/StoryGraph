...
public:
  explicit TestObject(const std::string& id) : SceneObjectBase(id, SceneObjectType::Custom) {}
...
TEST_CASE("Benchmark: Dialogue typewriter simulation", "[benchmark][dialogue]") {
  ...
  dialogue.setText("This is a test message for benchmarking typewriter performance with a "
