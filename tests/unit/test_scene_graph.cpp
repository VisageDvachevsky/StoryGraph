...
public:
  ...
  void drawText([[maybe_unused]] const renderer::Font& font,
                [[maybe_unused]] const std::string& text, [[maybe_unused]] f32 x,
                [[maybe_unused]] f32 y, [[maybe_unused]] const renderer::Color& color) override {}
  void setFade([[maybe_unused]] f32 alpha, [[maybe_unused]] const renderer::Color& color) override {
  }
...
public:
  ...
  void render([[maybe_unused]] renderer::IRenderer& renderer) override { renderCalled = true; }
...
TEST_CASE("ChoiceUIObject choices management", "[scene_graph][choice]") {
  ...
  std::vector<ChoiceUIObject::ChoiceOption> options = {{"opt1", "Option 1", true, true, ""},
...
TEST_CASE("ChoiceUIObject selection", "[scene_graph][choice]") {
  ...
  std::vector<ChoiceUIObject::ChoiceOption> options = {{"opt1", "First", true, true, ""},
...
TEST_CASE("SceneGraph object management", "[scene_graph]") {
  ...
  SECTION("Add to layer") {
    graph.addToLayer(LayerType::Background, std::make_unique<BackgroundObject>("bg1"));
...
TEST_CASE("SceneGraph convenience methods", "[scene_graph]") {
  ...
  SECTION("Show/hide character") {
    auto* char1 = graph.showCharacter("alice", "alice_id", CharacterObject::Position::Left);
  ...
  SECTION("Show/hide choices") {
    std::vector<ChoiceUIObject::ChoiceOption> opts = {{"opt1", "Choice 1", true, true, ""}};
